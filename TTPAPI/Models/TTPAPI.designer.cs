...
namespace TTPAPI.Models
{
    ...
    partial void DeleteDeviceCurrentLocation(DeviceCurrentLocation instance);
		...
		public System.Data.Linq.Table<CCTV_Detail> CCTV_Details
		{
			get
			{
				return this.GetTable<CCTV_Detail>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CCTV_Details")]
	public partial class CCTV_Detail
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AccountID", DbType="NChar(10) NOT NULL", CanBeNull=false)]
		public string AccountID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Port", DbType="NChar(10)")]
		public string Port
		{
			get
			{
